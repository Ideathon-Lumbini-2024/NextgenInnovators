...
const FundraiserCardNepal = () => {
  return (
    <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-md max-w-3xl mx-auto mt-24">
      {/* Header */}
      ...
      <div className="w-full">
        <img src={flood} alt="Landslide" className="rounded-lg w-full" />
      </div>
      {/* Organizer Info */}
      ...
      {/* Donation Summary */}
      <div className="flex flex-col items-center w-full border-t-2 border-black pt-4">
